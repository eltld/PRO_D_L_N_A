...
public class BrowseResult {
    ...
    public BrowseResult(String result, UnsignedIntegerFourBytes count, UnsignedIntegerFourBytes totalMatches, UnsignedIntegerFourBytes containerUpdateID) {
        ...
        Log.d( "BrowseResult", "totalMatches=" + totalMatches + "  count=" + count );
        Log.d( "BrowseResult", "result=" + result  );
    }
    ...
    public void setCount(UnsignedIntegerFourBytes count) {
        this.count = count;
    }

    public void setTotalMatches(UnsignedIntegerFourBytes totalMatches) {
        this.totalMatches = totalMatches;
    }

    public void setContainerUpdateID(UnsignedIntegerFourBytes containerUpdateID) {
        this.containerUpdateID = containerUpdateID;
    }
