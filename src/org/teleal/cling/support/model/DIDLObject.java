...
public abstract class DIDLObject {
    ...
    static public abstract class Property<V> {
        ...
        static public abstract class UPNP {
            ...
            static public class ALBUM_ART_URI extends Property<URI> implements NAMESPACE {
                public ALBUM_ART_URI() throws URISyntaxException {
                    this( null );
                }

                public ALBUM_ART_URI(URI value) throws URISyntaxException {
                    //为了简化存储的数据，因为本地资源的url 头是知道的
                    super( new URI( ((value != null && !value.toString( ).toLowerCase( ).startsWith( "http://" )) ? MediaServer.LocalURL : "") + value.toString( ) ), "albumArtURI" );
                }

                public ALBUM_ART_URI(URI value, List<Property<DIDLAttribute>> attributes) throws URISyntaxException {
                    super( new URI( ((value != null && !value.toString( ).toLowerCase( ).startsWith( "http://" )) ? MediaServer.LocalURL : "") + value.toString( ) ), "albumArtURI",
                            attributes );
                }
            }
    ...
    protected DIDLObject(DIDLObject other) {
        this( other.getId( ), other.getParentID( ), other.getTitle( ), other.getCreator( ), other.isRestricted( ), other.getWriteStatus( ), other.getClazz( ),
                other.getResources( ), other.getProperties( ), other.getDescMetadata( ) );
    }

    protected DIDLObject(String id, String parentID, String title, String creator, boolean restricted, WriteStatus writeStatus, Class clazz, List<Res> resources,
            List<Property> properties, List<DescMeta> descMetadata) {
        this.id = id;
        this.parentID = parentID;
        this.title = title == null ? "unKnow" : title;
