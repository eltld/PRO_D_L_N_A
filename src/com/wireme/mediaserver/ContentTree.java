...
public class ContentTree {
	...
	public final static String VIDEO_PREFIX = "videoItem_";
	public final static String AUDIO_PREFIX = "audioItem_";
	public final static String IMAGE_PREFIX = "imageItem_";
...
//	public ContentTree() {};
	...
	protected static ContentNode createRootNode() {
		...
		root.setId(ROOT_ID);
		root.setParentID("-1");
		root.setTitle("Android DLNA Server");
		root.setCreator("http://www.duanluo.com");
